...
const RegistrationForm = ({
  ...
  useEffect(() => {
    setPaymentRequired(attendeeState?.zone == 'zone3')
  }, [attendeeState?.zone])

  return (
    <fieldset disabled={attendeeState?.confirmed}>
      <Dialog
        heading='Registration submitteds'
        message='We will verify the details and confirm your registration, please check this page again for confirmation details.'
        isOpen={showDialog}
        onClose={() => {
          setShowDialog(false)
        }}
      ...
      <form
          ...
          <div className='inline-flex gap-4'>
            <div className='flex items-center px-4 border border-gray-300 rounded dark:border-gray-700'>
              <input
                ...
                type='radio'
                onChange={onChange}
                checked={attendeeState?.zone == 'zone1'}
                value='zone1'
                name='zone'
            ...
            <div className='flex items-center px-4 border border-gray-300 rounded dark:border-gray-700'>
              <input
                ...
                type='radio'
                onChange={onChange}
                checked={attendeeState?.zone == 'zone2'}
                value='zone2'
                name='zone'
                className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600'
              />
            ...
            <div className='flex items-center px-4 border border-gray-300 rounded dark:border-gray-700'>
              <input
                ...
                type='radio'
                onChange={onChange}
                checked={attendeeState?.zone == 'zone3'}
                value='zone3'
                name='zone'
                className='w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600'
              />
        ...
        <div className='flex items-center gap-6'>
          <button
            ...
            {attendee && !attendee.confirmed ? 'Update' : 'Register'}
          </button>
          <button
            type='button'
